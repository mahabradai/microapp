package com.simple5.microapp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.simple5.microapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.simple5.microapp.security.DomainUserDetailsService", "createSpringSecurityUser");
